...
{
    public class MobileProductionResultScanPalletizerRepository : IMobileProductionResultScanPalletizerRepository
    {
        private readonly DbExecutor _dbExecutor;

        public MobileProductionResultScanPalletizerRepository(DbExecutor dbExecutor)
        {
        ...
        {
            string sp = "sp_Wms_Mobile_ProductionResultScanPalletizer_GetDataBarcode";
        ...
        {
            string sql = "sp_Wms_Mobile_ProductionResultScanPalletizer_Submit";
        ...
        {
            string sp = "sp_Wms_Mobile_ProductionResultScanPalletizer_Capture";

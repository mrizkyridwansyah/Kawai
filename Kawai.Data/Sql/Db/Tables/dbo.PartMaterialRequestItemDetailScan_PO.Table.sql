...
GO
CREATE TABLE [PartMaterialRequestItemDetailScan_PO](
...
GO
ALTER TABLE [PartMaterialRequestItemDetailScan_PO]  WITH CHECK ADD FOREIGN KEY([IDSeq])
REFERENCES [PartMaterialRequestItemDetail_PO] ([IDSeq])
GO
ALTER TABLE [PartMaterialRequestItemDetailScan_PO]  WITH CHECK ADD FOREIGN KEY([ItemCode])

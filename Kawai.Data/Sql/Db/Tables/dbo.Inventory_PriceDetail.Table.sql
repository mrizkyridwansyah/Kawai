...
GO
CREATE TABLE [Inventory_PriceDetail](
 ...
 CONSTRAINT [PK_Inventory_PriceDetail_1] PRIMARY KEY CLUSTERED 
(
	[Period] ASC,
	[Item_Code] ASC,
	[Tgl] ASC,
...
GO
ALTER TABLE [Inventory_PriceDetail] ADD  CONSTRAINT [DF_Inventory_PriceDetail_Register_Date]  DEFAULT (getdate()) FOR [Register_Date]
GO

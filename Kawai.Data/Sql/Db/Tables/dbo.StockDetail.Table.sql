...
GO
ALTER TABLE [StockDetail]  WITH CHECK ADD  CONSTRAINT [CK__StockDetail] CHECK  (([StatusReceipt]='HOLD' OR [StatusReceipt]='OK' OR [StatusReceipt]='NG'))
GO
ALTER TABLE [StockDetail] CHECK CONSTRAINT [CK__StockDetail]
GO

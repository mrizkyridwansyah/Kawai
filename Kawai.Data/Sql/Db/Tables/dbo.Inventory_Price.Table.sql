...
CREATE TABLE [Inventory_Price](
 ...
 CONSTRAINT [PK_Inventory_Price] PRIMARY KEY CLUSTERED 
(
	[Inventory_Year] ASC,
	[Inventory_Month] ASC,
	[Item_Code] ASC,
...
GO
ALTER TABLE [Inventory_Price] ADD  CONSTRAINT [DF_Inventory_Price_Register_Date]  DEFAULT (getdate()) FOR [Register_Date]
GO

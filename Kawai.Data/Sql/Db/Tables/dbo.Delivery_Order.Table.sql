...
GO
ALTER TABLE [Delivery_Order] ADD  CONSTRAINT [DF_Delivery_Order_DOSeq_No]  DEFAULT ((0)) FOR [DOSeq_No]
GO
ALTER TABLE [Delivery_Order] ADD  CONSTRAINT [DF_Delivery_Order_Register_Date]  DEFAULT (getdate()) FOR [Register_Date]
GO

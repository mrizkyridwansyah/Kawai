...
CREATE   procedure [dbo].[sp_Wms_Warehouse_GetDetail]
...
begin
	select 
		...
		dbo.ConvertToDateTimeFromString(wh.Use_EndDay) UseEndDate, wh.Last_Update LastUpdate, us.FullName Lastuser 

...
CREATE  PROCEDURE [sp_Wms_Trade_InsUpd]
...
IF @POPayment_Terms = '' BEGIN SET @POPayment_Terms = NULL END
IF @Price_Condition = '' BEGIN SET @Price_Condition = NULL END
IF @Region_Cls = '' BEGIN SET @Region_Cls = NULL END
IF @Transportation_Cls = '' BEGIN SET @Transportation_Cls = NULL END

...
begin
	...
	begin try
		...
		values 
		(@ReceiptNo, @ReceiptDate, @SupplierCode, @DNNumber, @DNDate, @BCNumber, @BCType, @BCDate, @VehicleNo, getdate(), @RegisterBy, 1, @Transport, @Remarks, 'RECEIPT PO')
		...
		select @newid, @ReceiptDate, PONumber, ItemCode, UnitClsCode, ExpectedQty, TotalPacking, ReceiptQty, @Remarks from @Details

export default {
  activity: ["b", "22 12 18 12 15 21 9 3 6 12 2 12"],
  airplay: [
    "p",
    "M5 17H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-1",
    "g",
    "12 15 17 21 7 21 12 15",
  ],
  "alert-circle": ["c", "12 12 10", "l", "12 12 8 12", "l", "12 12.01 16 16"],
  "alert-octagon": [
    "g",
  ...
  aperture: [
    ...
    "14.31 2.83 16 16",
    "l",
    "16.62 10.88 12 21.94",
  ],
  archive: ["b", "21 8 21 21 3 21 3 8", "r", "1 3 22 5", "l", "10 14 12 12"],
  "arrow-down-left": ["l", "17 7 7 17", "b", "17 17 7 17 7 7"],
  "arrow-down-right": ["l", "7 17 7 17", "b", "17 7 17 17 7 17"],
  "arrow-down": ["l", "12 12 5 19", "b", "19 12 12 19 5 12"],
  "arrow-down-circle": [
    "c",
    "12 12 10",
    "b",
  ...
  "arrow-left": ["l", "19 5 12 12", "b", "12 19 5 12 12 5"],
  "arrow-right-circle": [
    "c",
    "12 12 10",
    "b",
  ...
  "arrow-right": ["l", "5 19 12 12", "b", "12 5 19 12 12 19"],
  "arrow-up-circle": [
    "c",
    "12 12 10",
    "b",
  ...
  "arrow-up-left": ["l", "17 7 17 7", "b", "7 17 7 7 17 7"],
  "arrow-up-right": ["l", "7 17 17 7", "b", "7 7 17 7 17 17"],
  "arrow-up": ["l", "12 12 19 5", "b", "5 12 12 5 19 12"],
  "at-sign": [
    "c",
    "12 12 4",
    "p",
  ...
  "bar-chart-2": ["l", "18 18 20 10", "l", "12 12 20 4", "l", "6 6 20 14"],
  award: ["c", "12 8 7", "b", "8.21 13.89 7 23 12 20 17 23 15.79 13.88"],
  "bar-chart": ["l", "12 12 20 10", "l", "18 18 20 4", "l", "6 6 20 16"],
  "battery-charging": [
    "p",
    ...
    "23 23 13 11",
    "b",
    "11 6 7 12 13 12 9 18",
  ],
  battery: ["r", "1 6 18 12 2 2", "l", "23 23 13 11"],
  "bell-off": [
    "p",
  ...
  bluetooth: ["b", "6.5 6.5 17.5 17.5 12 23 12 1 17.5 6.5 6.5 17.5"],
  book: [
    "p",
  ...
  check: ["b", "20 6 9 17 4 12"],
  "chevron-left": ["b", "15 18 9 12 15 6"],
  "chevron-down": ["b", "6 9 12 15 18 9"],
  "chevron-up": ["b", "18 15 12 9 6 15"],
  "chevron-right": ["b", "9 18 15 12 9 6"],
  "chevrons-down": ["b", "7 13 12 18 17 13", "b", "7 6 12 11 17 6"],
  "chevrons-left": ["b", "11 17 6 12 11 7", "b", "18 17 13 12 18 7"],
  "chevrons-right": ["b", "13 17 18 12 13 7", "b", "6 17 11 12 6 7"],
  "chevrons-up": ["b", "17 11 12 6 7 11", "b", "17 18 12 13 7 18"],
  chrome: [
    "c",
    "12 12 10",
    "c",
  ...
  clock: ["c", "12 12 10", "b", "12 6 12 12 16 14"],
  "cloud-drizzle": [
    "l",
    "8 8 19 21",
    "l",
  ...
  code: ["b", "16 18 22 12 16 6", "b", "8 6 2 12 8 18"],
  codesandbox: [
    "p",
    "M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z",
    "b",
    "7.5 4.21 12 6.81 16.5 4.21",
    "b",
    "7.5 19.79 7.5 14.6 3 12",
    "b",
    "21 12 16.5 14.6 16.5 19.79",
    "b",
    "3.27 6.96 12 12.01 20.73 6.96",
    "l",
    "12 12 22.08 12",
  ...
  "corner-down-left": ["b", "9 10 4 15 9 20", "p", "M20 4v7a4 4 0 0 1-4 4H4"],
  "corner-down-right": [
    "b",
    "15 10 20 15 15 20",
    "p",
  ...
  "corner-left-up": ["b", "14 9 9 4 4 9", "p", "M20 20h-7a4 4 0 0 1-4-4V4"],
  "corner-right-down": [
    "b",
    "10 15 15 20 20 15",
    "p",
  ...
  "corner-right-up": ["b", "10 9 15 4 20 9", "p", "M4 20h7a4 4 0 0 0 4-4V4"],
  "corner-up-right": ["b", "15 14 20 9 15 4", "p", "M4 20v-7a4 4 0 0 1 4-4h12"],
  "corner-up-left": ["b", "9 14 4 9 9 4", "p", "M20 20v-7a4 4 0 0 0-4-4H4"],
  cpu: [
    "r",
    "4 4 16 16 2 2",
    "r",
  ...
  "credit-card": ["r", "1 4 22 16 2 2", "l", "1 23 10 10"],
  crosshair: [
    "c",
    "12 12 10",
    "l",
  ...
  divide: ["c", "12 6 2", "c", "12 18 2", "l", "5 19 12 12"],
  "download-cloud": [
    "b",
    "8 17 12 21 16 17",
    "l",
  ...
  "edit-2": ["p", "M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"],
  ...
  "fast-forward": ["g", "13 19 22 12 13 5 13 19", "g", "2 19 11 12 2 5 2 19"],
  figma: [
    "p",
  ...
  framer: ["p", "M5 16V9h14V2H5l14 14h-7m-7 0l7 7v-7m-7 0h7"],
  gift: [
    "b",
    "20 12 20 22 4 22 4 12",
    "r",
    "2 7 20 5",
    "l",
    "12 12 22 7",
  ...
  "git-commit": ["c", "12 12 4", "l", "1.05 7 12 12", "l", "17.01 22.96 12 12"],
  "git-branch": [
    "l",
    "6 6 3 15",
    "c",
  ...
  "git-merge": ["c", "18 18 3", "c", "6 6 3", "p", "M6 21V9a9 9 0 0 0 9 9"],
  github: [
    "p",
  ...
  image: ["r", "3 3 18 18 2 2", "c", "8.5 8.5 1.5", "b", "21 15 16 10 5 21"],
  inbox: [
    "b",
  ...
  info: ["c", "12 12 10", "l", "12 12 16 12", "l", "12 12.01 8 8"],
  italic: ["l", "19 10 4 4", "l", "14 5 20 20", "l", "15 9 4 20"],
  instagram: [
    "r",
    "2 2 20 20 5 5",
    "p",
  ...
  "life-buoy": [
    ...
    "4.93 9.17 4.93 9.17",
    "l",
    "14.83 19.07 14.83 19.07",
    "l",
    "14.83 19.07 9.17 4.93",
    "l",
    "14.83 18.36 9.17 5.64",
    "l",
    "4.93 9.17 19.07 14.83",
  ],
  link: [
    "p",
  ...
  loader: [
    ...
    "4.93 7.76 4.93 7.76",
    "l",
    "16.24 19.07 16.24 19.07",
    "l",
    "2 6 12 12",
    "l",
    "18 22 12 12",
    "l",
    "4.93 7.76 19.07 16.24",
    "l",
    "16.24 19.07 7.76 4.93",
  ],
  ...
  layout: ["r", "3 3 18 18 2 2", "l", "3 21 9 9", "l", "9 9 21 9"],
  "maximize-2": [
    "b",
    "15 3 21 3 21 9",
    "b",
  ...
  menu: ["l", "3 21 12 12", "l", "3 21 6 6", "l", "3 21 18 18"],
  "message-circle": [
    "p",
  ...
  "minus-circle": ["c", "12 12 10", "l", "8 16 12 12"],
  "minus-square": ["r", "3 3 18 18 2 2", "l", "8 16 12 12"],
  monitor: ["r", "2 3 20 14 2 2", "l", "8 16 21 21", "l", "12 12 17 21"],
  minus: ["l", "5 19 12 12"],
  ...
  "navigation-2": ["g", "12 2 19 21 12 17 5 21 12 2"],
  octagon: [
    "g",
    "7.86 2 16.14 2 22 7.86 22 16.14 16.14 22 7.86 22 2 16.14 2 7.86 7.86 2",
  ],
  navigation: ["g", "3 11 22 2 13 21 11 13 3 11"],
  paperclip: [
    "p",
  ...
  "pause-circle": ["c", "12 12 10", "l", "10 10 15 9", "l", "14 14 15 9"],
  "pen-tool": [
    "p",
  ...
  percent: ["l", "19 5 5 19", "c", "6.5 6.5 2.5", "c", "17.5 17.5 2.5"],
  "phone-call": [
    "p",
  ...
  "play-circle": ["c", "12 12 10", "g", "10 8 16 12 10 16 10 8"],
  play: ["g", "5 3 19 12 5 21 5 3"],
  "plus-circle": ["c", "12 12 10", "l", "12 12 8 16", "l", "8 16 12 12"],
  plus: ["l", "12 12 5 19", "l", "5 19 12 12"],
  "plus-square": ["r", "3 3 18 18 2 2", "l", "12 12 8 16", "l", "8 16 12 12"],
  pocket: [
    "p",
  ...
  power: ["p", "M18.36 6.64a9 9 0 1 1-12.73 0", "l", "12 12 2 12"],
  printer: [
    "b",
    "6 9 6 2 18 2 18 9",
    "p",
  ...
  rewind: ["g", "11 19 2 12 11 5 11 19", "g", "22 19 13 12 22 5 22 19"],
  "rotate-ccw": [
    "b",
    "1 4 1 10 7 10",
    "p",
  ...
  search: ["c", "11 11 8", "l", "21 16.65 21 16.65"],
  send: ["l", "22 11 2 13", "g", "22 2 15 22 11 13 2 9 22 2"],
  settings: [
    "c",
    "12 12 3",
    "p",
  ...
  "share-2": [
    ...
    "18 19 3",
    "l",
    "8.59 15.42 13.51 17.49",
    "l",
    "15.41 8.59 6.51 10.49",
  ],
  share: [
    "p",
  ...
  sidebar: ["r", "3 3 18 18 2 2", "l", "9 9 3 21"],
  "shopping-cart": [
    "c",
    "9 21 1",
    "c",
  ...
  "skip-forward": ["g", "5 4 15 12 5 20 5 4", "l", "19 19 5 19"],
  "skip-back": ["g", "19 20 9 12 19 4 19 20", "l", "5 5 19 5"],
  slack: [
    "p",
  ...
  slash: ["c", "12 12 10", "l", "4.93 19.07 4.93 19.07"],
  sliders: [
    "l",
    "4 4 21 14",
    "l",
  ...
  smartphone: ["r", "5 2 14 20 2 2", "l", "12 12.01 18 18"],
  smile: [
    "c",
    "12 12 10",
    "p",
  ...
  speaker: ["r", "4 2 16 20 2 2", "c", "12 14 4", "l", "12 12.01 6 6"],
  square: ["r", "3 3 18 18 2 2"],
  "stop-circle": ["c", "12 12 10", "r", "9 9 6 6"],
  star: [
    "g",
  ...
  sun: [
    ...
    "4.22 5.64 4.22 5.64",
    "l",
    "18.36 19.78 18.36 19.78",
    "l",
    "1 3 12 12",
    "l",
    "21 23 12 12",
    "l",
    "4.22 5.64 19.78 18.36",
    "l",
    "18.36 19.78 5.64 4.22",
  ],
  sunrise: [
    "p",
    ...
    "12 12 2 9",
    "l",
    "4.22 5.64 10.22 11.64",
    "l",
    "1 3 18 18",
    "l",
    "21 23 18 18",
    "l",
    "18.36 19.78 11.64 10.22",
    "l",
    "23 1 22 22",
    "b",
    "8 6 12 2 16 6",
  ...
  tablet: ["r", "4 2 16 20 2 2", "l", "12 12.01 18 18"],
  ...
  terminal: ["b", "4 17 10 11 4 5", "l", "12 20 19 19"],
  "thumbs-down": [
    "p",
  ...
  "toggle-left": ["r", "1 5 22 14 7 7", "c", "8 12 3"],
  "toggle-right": ["r", "1 5 22 14 7 7", "c", "16 12 3"],
  tool: [
    "p",
  ...
  trello: ["r", "3 3 18 18 2 2", "r", "7 7 3 9", "r", "14 7 3 5"],
  "trending-up": ["b", "23 6 13.5 15.5 8.5 10.5 1 18", "b", "17 6 23 6 23 12"],
  triangle: [
    "p",
    "M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z",
  ],
  ...
  tv: ["r", "2 7 20 15 2 2", "b", "17 2 12 7 7 2"],
  twitch: ["p", "M21 2H3v16h5v4l4-4h5l4-4V2zm-10 9V7m5 4V7"],
  twitter: [
    "p",
    "M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z",
  ],
  type: ["b", "4 7 4 4 20 4 20 7", "l", "9 15 20 20", "l", "12 12 4 20"],
  umbrella: ["p", "M23 12a11.05 11.05 0 0 0-22 0zm-5 7a3 3 0 0 1-6 0v-7"],
  underline: ["p", "M6 3v7a6 6 0 0 0 6 6 6 6 0 0 0 6-6V3", "l", "4 20 21 21"],
  "upload-cloud": [
    "b",
    "16 16 12 12 8 16",
    "b",
  ...
  video: ["g", "23 7 16 12 23 17 23 7", "r", "1 5 15 14 2 2"],
  "video-off": [
    "p",
  ...
  voicemail: ["c", "5.5 11.5 4.5", "c", "18.5 11.5 4.5", "l", "5.5 18.5 16 16"],
  "volume-1": [
    "g",
  ...
  volume: ["g", "11 5 6 9 2 9 2 15 6 15 11 19 11 5"],
  "volume-x": [
    "g",
    "11 5 6 9 2 9 2 15 6 15 11 19 11 5",
    "l",
  ...
  "x-circle": ["c", "12 12 10", "l", "15 9 9 15", "l", "9 15 9 15"],
  wind: [
    "p",
  ...
  "x-square": ["r", "3 3 18 18 2 2", "l", "9 15 9 15", "l", "15 9 9 15"],
  ...
  "zap-off": [
    "b",
    "12.41 6.75 13 2 10.57 4.92",
    "b",
    "18.57 12.91 21 10 15.66 10",
    "b",
    "8 8 3 14 12 14 11 22 16 16",
    "l",
    "1 23 1 23",
  ],
  ...
  "zoom-out": ["c", "11 11 8", "l", "21 16.65 21 16.65", "l", "8 14 11 11"],
};

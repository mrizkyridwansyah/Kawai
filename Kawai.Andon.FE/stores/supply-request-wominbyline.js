var app = useNuxtApp();
export const useSupplyRequestWominByLine = defineStore("SupplyRequestWominByLine", {
  persist: {
  ...
  actions: {
     ...
     loadListScan: function () {
      ...
      return new Promise((resolve, reject) => {
        app.$http
          .post(`/andon/womin-request/list-womindetailbyline`, this.filterListScan)
          .then(({ data }) => {
...
if (import.meta.hot) {
  import.meta.hot.accept(
    acceptHMRUpdate(useSupplyRequestWominByLine, import.meta.hot),
  );
}

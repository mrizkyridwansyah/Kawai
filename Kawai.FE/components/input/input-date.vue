...
export default {
  ...
  watch: {
    modelValue: function (after, before) {
      ...
      this.tempValue = this.$func.asUtcStringDateOnly(d);
    },
    tempValue: function (after, before) {
      ...
      var d = new Date(after);
      this.$emit("update:modelValue", this.$func.asUtcStringDateOnly(d));
    },
  },
  mounted: function () {
    if (this.modelValue) {
      var d = new Date(this.modelValue);
      this.tempValue = moment(this.$func.asUtcStringDateOnly(d)).toISOString();
    }
  },
  methods: {
    change: function (e) {

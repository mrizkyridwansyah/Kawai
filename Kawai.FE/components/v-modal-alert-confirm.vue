    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <span> Are you sure to confirm the data? </span>
          <!-- <div class="mt-5">
            <label>Reason</label>
            <input-text 
              label="Reason"
          ...
          <div class="d-flex justify-content-end mt-4">
            ...
            <button
              class="btn btn-danger btn-sm rounded-pill ms-3 btn-cancel"
              @click="confirm"
              :disabled="isLoading"
            >
              <div
...
<style lang="scss">
.btn-cancel {
  animation: pulse-button-info 2s infinite;
}

@-webkit-keyframes pulse-button-info {
  0% {
    color: #fff;
    background: #49dc35ff;
...
@keyframes pulse-button-info {
  0% {
    color: #fff;
    background: #49dc35ff;
    -webkit-box-shadow: 0 0 0 0 rgba(59, 220, 53, 0.8);
    box-shadow: 0 0 0 0 rgba(59, 220, 53, 0.8);
  }

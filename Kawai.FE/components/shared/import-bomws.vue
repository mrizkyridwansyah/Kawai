      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-md-4 mb-3">
            <label class="fw-bold">Line Code</label>
            ...
            <input
              ...
              :class="{
                'is-invalid':
                importResult?.Data?.Header?.Errors?.includes('LineCode')
              }"
              :value="importResult?.Data?.Header?.LineCode"
            >
          </div>

          <div class="col-md-4 mb-3">
            <label class="fw-bold">Parent Item Code</label>

            <input
              type="text"
              class="form-control"
              readonly
              :value="importResult?.Data?.Header?.ParentItemCode"
            >
          </div>

            <div class="col-md-4 mb-3">
            <label class="fw-bold">WorkStation Code</label>

            <input
              type="text"
              class="form-control"
              readonly
              :value="importResult?.Data?.Header?.WorkStationCode"
            >
          </div>
           <div class="col-md-4 mb-3">
            <label class="fw-bold">Trolley Cls</label>

            <input
              type="text"
              class="form-control"
              readonly
              :value="importResult?.Data?.Header?.TrolleyCls"
            >
          </div>

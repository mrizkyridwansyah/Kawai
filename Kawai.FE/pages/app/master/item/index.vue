  ...
  methods: {
    ...
    selectItem: function (dt) {
      ...
      this.model = {
        ...
        FinishGoodPartCls: dt.FinishGoodPartCls,
        DrawingNumber: dt.DrawingNumber,
        WarehouseCode: dt.WarehouseCode,
        Address: dt.Address,
        SupplierCode: dt.SupplierCode,
        DeliveryPlaceCode: dt.DeliveryPlaceCode,
        ManufactureCode: dt.ManufactureCode,
        LineCode: dt.LineCode,
        MakerItemCode: dt.MakerItemCode,
        PartCls: dt.PartCls,
        MaterialCls: dt.MaterialCls,
        SheetCoilCls: dt.SheetCoilCls,
        DrawingMaterialCls: dt.DrawingMaterialCls,
        SurfaceTreatmentCls: dt.SurfaceTreatmentCls,
        HeatTreatmentCls: dt.HeatTreatmentCls,
        PackingStyleCls: dt.PackingStyleCls,
        GroupCls: dt.GroupCls,
        MakeBuyCls: dt.MakeBuyCls,
        ControlCls: dt.ControlCls,
        PackingStyleMaterialCls: dt.PackingStyleMaterialCls,
        AccountingCode: dt.AccountingCode,
        ExplosionCls: dt.ExplosionCls,
        PersonInChargeCls: dt.PersonInChargeCls,
        SupplyIssueCls: dt.SupplyIssueCls,
        UnitCls: dt.UnitCls,
        HSCode: dt.HSCode,
        TypeAccs: dt.TypeAccs,
        ModelCls: dt.ModelCls,
        POTypeCls: dt.POTypeCls,
        ClasificationPartCls: dt.ClasificationPartCls,
        DestinationCls: dt.DestinationCls,
        ColorCls: dt.ColorCls,
        Thickness: dt.Thickness,
        Width: dt.Width,
        Length: dt.Length,
        Weight: dt.Weight,
        Pitch: dt.Pitch,
        NumberProducible: dt.NumberProducible,
        ScrapWeight: dt.ScrapWeight,
        SurfaceOrderPointQty: dt.SurfaceOrderPointQty,
        HeatOrderPointQty: dt.HeatOrderPointQty,
        Sample: dt.Sample,
        SWQty: dt.SWQty,
        EWQty: dt.EWQty,
        NumberProcess: dt.NumberProcess,
        MaterialCoefficient: dt.MaterialCoefficient,
        ProcessCoefficient: dt.ProcessCoefficient,
        MinLot: dt.MinLot,
        LotQty: dt.LotQty,
        LotCoefficience: dt.LotCoefficience,
        ProductReadTime: dt.ProductReadTime,
        YieldPercentage: dt.YieldPercentage,
        NumberEntering: dt.NumberEntering,
        StandardStock: dt.StandardStock,
        SafetyStock: dt.SafetyStock,
        MaxStock: dt.MaxStock,
        MinStock: dt.MinStock,
        AlowanceDay: dt.AlowanceDay,
        DeliveryReadTime: dt.DeliveryReadTime,
        OrderPointQty: dt.OrderPointQty,
        NumberBox: dt.NumberBox,
        UseEndDay: dt.UseEndDay,
        MinOrder: dt.MinOrder,
        SafetyStockPercentage: dt.SafetyStockPercentage,
        ReserveCls: dt.ReserveCls,
        SupplyCls: dt.SupplyCls,
        ProvisionCls: dt.ProvisionCls,
        ProductionCls: dt.ProductionCls,
        StockControlCls: dt.StockControlCls,
      };

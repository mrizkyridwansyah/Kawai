...
export const useShippingInstructionScan = defineStore("ShippingInstructionScan", {
  persist: {
  ...
  actions: {
     ...
     loadListScan: function () {
      ...
      return new Promise((resolve, reject) => {
        app.$http
          .post(`/shipping-instruction/list-picking`, this.filterListScan)
          .then(({ data }) => {
    ...
    submit: function (data) {
            this.isLoading = true;
            return new Promise((resolve, reject) => {
                app.$http.post(`/shipping-instruction/save-picking`, data)
                    .then(({ data }) => {
                        resolve(data);
                    })
...
if (import.meta.hot) {
  import.meta.hot.accept(
    acceptHMRUpdate(useShippingInstructionScan, import.meta.hot),
  );
}

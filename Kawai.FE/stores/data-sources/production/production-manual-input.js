...
export const useProductionManual = defineStore('ProductionManual', {
  persist: {
  ...
  actions: {
    load: function () {
      ...
      return new Promise((resolve, reject) => {
        app.$http.post(`/production/manual-input/list-header`, this.filter)
          .then(({ data }) => {
            this.data = data.Data;
            resolve(data);
          })
    ...
    loadDetail: function () {
      ...
      return new Promise((resolve, reject) => {
        app.$http.post(`/production/manual-input/list-detail`, this.newRequest)
          .then(({ data }) => {
    ...
    loadListStock: function () {
      ...
      return new Promise((resolve, reject) => {
        app.$http.post(`/production/manual-input/list-stock`, this.filterListStock)
          .then(({ data }) => {
    ...
    save: function (data) {
      ...
      return new Promise((resolve, reject) => {
        app.$http.post(`/production/manual-input/save`, data)
          .then(({ data }) => {
            resolve(data);
          })
    ...
    remove: function (id, reqNo) {
      ...
      return new Promise((resolve, reject) => {
        app.$http.delete(`/production/manual-input/remove?requestId=${id}&requestNo=${reqNo}`)
          .then(({ data }) => {
            resolve(data);
          })
          .catch((err) => reject(err.response?.data))
    ...
    print(data) {
      ...
      return new Promise((resolve, reject) => {
        app.$http.post(
          `/production/manual-input/print-barcodes`,
          data,
          { responseType: 'blob' }
        )
          .then(res => {
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useProductionManual, import.meta.hot));
}
...
export const useProductionqualityjudgement = defineStore('ProductionQualityJudgement', {
  persist: {
  ...
  actions: {
    load: function () {
      ...
      return new Promise((resolve, reject) => {
        app.$http.post(`/productionjudgement/quality-judgement/list-header`, this.filter)
          .then(({ data }) => {
            this.data = data.Data;
            resolve(data);
          })
    ...
    save: function (data) {
      ...
      return new Promise((resolve, reject) => {
        app.$http.post(`/productionjudgement/quality-judgement/save`, data)
          .then(({ data }) => {
            resolve(data);
          })
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useProductionqualityjudgement, import.meta.hot));
}
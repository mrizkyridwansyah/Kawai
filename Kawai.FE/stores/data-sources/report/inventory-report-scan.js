...
export const useInventoryReportScan = defineStore("InventoryReportScan", {
  persist: {
  ...
  actions: {
     ...
     loadListScan: function () {
      ...
      return new Promise((resolve, reject) => {
        app.$http
          .post(`/inventory-report/list-scan`, this.filterListScan)
          .then(({ data }) => {
...
if (import.meta.hot) {
  import.meta.hot.accept(
    acceptHMRUpdate(useInventoryReportScan, import.meta.hot),
  );
}

...
export const useReceiptSupplyHistory = defineStore('ReceiptSupplyHistory', {
  state: () => ({
    isLoading: false,
    isCreating: false,
    isEditing: false,
  ...
  actions: {
    load: function () {
      ...
      return new Promise((resolve, reject) => {
        app.$http.post(`/receipt-supply-history/list`, this.filter)
          .then(({ data }) => {
            this.data = data.Data;
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useReceiptSupplyHistory, import.meta.hot));
}
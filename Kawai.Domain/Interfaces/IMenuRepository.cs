...
public interface IMenuRepository
{
    ...
    Task<List<GroupingClassDto>> GetAllGroupingClassIncludePrivileges(string userId);
    Task<List<MenuMobileDto>> GetAllMenuMobileIncludePrivileges(string userId);
    Task<List<MenuDto>> GetUserMenuPrivileges(string userId);
    Task<List<MenuMobileDto>> GetUserMenuMobilePrivileges(string userId);

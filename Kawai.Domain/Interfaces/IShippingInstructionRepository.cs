...
public interface IShippingInstructionRepository
{
    ...
    Task<List<ShippingInstructionFilterDto>> GetSIDDL(string keyword, string supplier, DateTime? periodFrom, DateTime? periodUntil, string sourceMenu, string orderEntry, string userId);
